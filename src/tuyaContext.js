...
exports.TuyaContext = void 0;
var core_1 = require("./core");
var service_1 = require("./service");
var TuyaContext = /** @class */ (function () {
    function TuyaContext(opt) {
    ...
    TuyaContext.prototype.request = function (opt) {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.request(opt)];
                    case 1:
                        res = _a.sent();
...
exports.TuyaContext = TuyaContext;
